...
<html lang="en">
  ...
  <form action="{{ url('reservation') }}" method="post">
    ...
    <div class="card px-1 py-4">
        <div class="card-body">
            <h6 class="card-title mb-3">Information réservation</h6>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="text" name="depart" placeholder="Votre point de  Depart"> </div>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="text" name="destination" placeholder="Votre Destination"> </div>
                    </div>
                    </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="date" name="dated" placeholder="Date de Depart"> </div>
                    </div>
                    </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="time" name="heure" placeholder="Heure de Depart"> </div>
                    </div>
                    </div>
            </div>
            <div class="row">
                <div class="col-sm-12">
                    <div class="form-group">
                        <div class="input-group"> <input class="form-control" type="number" name="telephone" placeholder="Numero de telephone"> </div>
                    </div>
                    </div>
            </div>
...
termes et conditions</a> </div>  <input type="submit" value="Réserver" class="btn btn-primary">
...
<a href="#" class="bouton">Contacter notre équipe</a>
<br><br>